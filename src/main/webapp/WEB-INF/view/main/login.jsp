...
<div class="all">
	<div class="mainDiv">
		<div class="header">
			...
			<div style="margin-top:20px;"><h1><span style="color:#ff6b00;">EMIS</span>&nbsp;企业移动信息系统</h1></div>
		</div>
		<div class="content"style="margin-top:-70px;">
			<!-- <form action="loginForSpringSecurity" method="post" class="loginDiv" id="loginForm"> -->
			<!-- <form  class="loginDiv" id="loginForm"> -->
			<div id="pms">
				<form action="login.html" method="post" class="loginDiv" id="loginForm">
...
<div style=" background:#cccccc;">
	<div id="footer">
			...
			<p style="margin-top:-30px;">COPYRIGHT © MERRYPLUS.COM 广东佰悦网络科技有限公司 | 粤ICP备12086987号-9</p>
	</div>
</div>
